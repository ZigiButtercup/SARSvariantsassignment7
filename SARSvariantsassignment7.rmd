...
This analysis aims to investigate the COVID-19 Genomics UK Consortium (COG-UK) genomic sequence data for England, which was collected by the Wellcome Sanger Institute. COVID-19 is a respiratory illness caused by the SARS-CoV-2 virus that was first identified in Wuhan, China in late 2019. The virus quickly spread worldwide, leading to a global pandemic. Here, I analyse the growth and reproduction rates of SARS-CoV-2 variants using the COG-UK data, as well as exploring the impact of differing sampling strategies, such as those used to collect the ONS-CIS (Office for National Statistics COVID-19 Infection Survey) data.
